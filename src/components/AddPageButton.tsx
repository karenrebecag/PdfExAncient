...
import "../styles/addPageButton.scss";
...
const AddPageButton: React.FC<AddPageButtonProps> = ({ onClick }) => {
  return (
    <button className="buttonAddPage" onClick={onClick}>
      <svg
        viewBox="0 0 32 32"
        version="1.1"
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" data-sketch-type="MSPage">
            <g
              id="Icon-Set-Filled"
              data-sketch-type="MSLayerGroup"
      ...
      <span className="textAdd">Añadir</span>
    </button>
  );
};
